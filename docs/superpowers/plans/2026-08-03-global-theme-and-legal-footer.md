...
- [ ] **Step 1: Write failing global-theme assertions**
...
- [ ] **Step 3: Implement the shared theme script**
...
- [ ] **Step 4: Connect all pages to the shared theme**
...
- [ ] **Step 1: Extend the failing test with legal requirements**
...
- [ ] **Step 2: Run the test and verify legal assertions fail**

Run: `& ./tests/global-theme-and-legal-footer.ps1`

Expected: FAIL on the missing common footer requirements.

- [ ] **Step 3: Create responsive shared footer styles**
...
- [ ] **Step 4: Add complete legal footers to the main pages**
...
- [ ] **Step 5: Add compact legal footers to utility pages**
...
- [ ] **Step 6: Run full static assertions**
...
- [ ] **Step 1: Verify locally in Chrome**
