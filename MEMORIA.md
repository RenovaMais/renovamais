...
| Domínio | Função | Estado |
|---------|--------|--------|
| renovamais.pt | Principal (Produção) | ✅ Online |
| renovamais.com | Redirect 301 → renovamais.pt | ✅ Online |
| www.renovamais.pt | Redirect 301 → renovamais.pt | ✅ Online |
| www.renovamais.com | Redirect 301 → renovamais.pt | ✅ Online |
| renovamais.vercel.app | Vercel default (sempre funciona) | ✅ Online |

**Registar:** Dominios.PT (my.dominios.pt)
**Conta:** alexfelgo@gmail.com

---

## 🔧 DNS — RENOVAMAIS.PT (Dominios.PT)

| Tipo | Nome | Valor | TTL | Prio |
|------|------|-------|-----|------|
| A | renovamais.pt | 216.198.79.1 | 1h | 0 |
| MX | renovamais.pt | mx1.improvmx.com | 1h | 10 |
| MX | renovamais.pt | mx2.improvmx.com | 1h | 20 |
...
| NS | renovamais.pt | dns4.host-redirect.com | 7200 | 0 |

## 🔧 DNS — RENOVAMAIS.COM (Dominios.PT)

| Tipo | Nome | Valor | TTL | Prio |
|------|------|-------|-----|------|
| A | renovamais.com | 76.76.21.21 | 1h | 0 |
| CNAME | www.renovamais.com | f0b4556fd019ea40.vercel-dns-017.com | 1h | 0 |
| NS | renovamais.com | dns1.host-redirect.com | - | - |
| NS | renovamais.com | dns2.host-redirect.com | - | - |
| NS | renovamais.com | dns3.host-redirect.com | - | - |
| NS | renovamais.com | dns4.host-redirect.com | - | - |
...
|-------|-------|
| Projecto | renovamais |
| GitHub repo | https://github.com/RenovaMais/renovamais |
| Team | Alex Filipe's projects |
| API Token | ver ficheiro `.credentials` (local, não versionado) |
| Deploy | Automático via push para branch `main` |
| IP Vercel (novo) | 216.198.79.1 |
| IP Vercel (antigo, funciona) | 76.76.21.21 |
| CNAME Vercel | f0b4556fd019ea40.vercel-dns-017.com |
...
| Campo | Valor |
|-------|-------|
| Serviço | ImprovMX (improvmx.com) |
| Conta | geral.Renovamais@gmail.com |
| API Key | ver ficheiro `.credentials` (local) |
| Domínio | renovamais.pt |
| Alias wildcard | * @renovamais.pt → geral.Renovamais@gmail.com |
...
| Campo | Valor |
|-------|-------|
| Measurement ID | G-EXPZ8HG8RB |
| Stream ID | 15015367140 |
| Stream URL | https://renovamais.pt |
| API Secret | ver ficheiro `.credentials` (local) |
| Conta Google | alexfelgo@gmail.com |
...
| Campo | Valor |
|-------|-------|
| Propriedade | https://renovamais.pt |
| Verificação | Tag HTML (ver `.credentials`) |
| Sitemap submetido | https://renovamais.pt/sitemap.xml |
| Conta Google | alexfelgo@gmail.com |
...
| ImprovMX API Key | app.improvmx.com → Chaves de API |
...
```
C:\Users\Aleke\Documents\Claud-Code\renovamais\
```
